...
#Abdul Zainul-abedin 1000617275
...
class Player(pygame.sprite.Sprite):
    def __init__(self,all_sprite,bullet):
        pygame.sprite.Sprite.__init__(self)
    ...
    def update(self):
        ...
        if self.power >=2 and pygame.time.get_ticks() - self.power_time > POWERUP_TIME:
            self.power -= 1
            self.power_time = pygame.time.get_ticks()
        print("power = " + str(self.power) + " Power Time= " + str(self.power_time))
       # print("_")
        ...
        ## will give back a list of the keys which happen to bke pressed down at that moment
